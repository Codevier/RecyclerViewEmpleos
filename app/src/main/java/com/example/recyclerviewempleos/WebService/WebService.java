package com.example.recyclerviewempleos.WebService;
...
import com.example.recyclerviewempleos.WebService.HttpRequest.HttpRequestException;
...
public class WebService extends AsyncTask<String, Long, String> {
    ...
    protected void onPreExecute() {
        ...
        progDailog.setMessage("Cargando Lista de Empleos...");
